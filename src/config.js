const config = {
  ...
  mentalModels: [
    ...
    { icon: "📐", title: "Constraints clarify thinking", text: "The best outputs, whether code, prompts, or designs, come from explicit constraints. Vague inputs produce vague outputs. This applies to AI and to requirements." },
  ...
  featuredProjects: [
    {
      ...
      challenge: "AI agents browsing the web can be hijacked by prompt-injection payloads hidden in page content, such as CSS-concealed text, off-screen positioning, color-matched text, and aria-hidden nodes, invisible to a human but readable by an agent.",
      ...
      impact: [
        ...
        "Sub-100ms synchronous detection path, built with a TypeScript engine, MV3 content script, service worker, and Shadow DOM popup UI",
        "Solo build in 3 weekends, shipped to the Chrome Web Store, with 49 installs at ~90% retention and zero promotion",
  ...
  experience: [
    {
      ...
      projects: [
        { name: "Computer Vision & AI Tooling - Firmware Automation Support", period: "Mar 2025 – Present", summary: "Built a ResNet + FAISS computer-vision service identifying printer UI elements from screenshots, replacing a paid Azure AI Vision dependency and cutting recurring cost, containerised with Docker and Docker Compose for Windows and Linux. Developed an AI onboarding assistant on Copilot for HP's automation framework, covering script explanation, syntax guidance, and code generation, placing 2nd of 13 developers in the internal hackathon. Technical point of contact resolving 15+ tickets monthly at ~80% first-contact resolution for 30+ QA engineers across 3 time zones.", tags: ["Python", "Computer Vision", "FAISS", "Docker", "AI Chatbot"] },
  ...
  achievements: [
    ...
    { icon: "🚀", text: "Project Shipyard S2, an AI Learn Circle cohort backed by Venture Catalysts, Antler, Bhive, and Paytm" },
  ],
