...
function Block({block}){
  switch(block.type){
    ...
    case"image":return<div className="mb-8 rounded-xl overflow-hidden" style={{border:"1px solid var(--border)"}}><img src={block.src} alt={block.alt||""} style={{width:"100%",display:"block"}}/></div>;
    default:return null;
  }
}
